...
public class Utils {
    ...
    /*
     * formatDate use to format date to show in GUI
     */
    ...
    public static String formSHOWSTATUS(String userName, String post, String cDate) {
        return "< " + userName + " >:    " + post + "        : Created -   " + cDate;
    }
    ...
    /*
     * listFriendsIgnoreUserLogin use to get list friends that ignore user logging in 
     */
    ...
    /*
     * getPrivateMessage use to get list of Private messages in user device
     */
    ...
    /*
     * checkPostInList use to check whether the post is showing in the list
     */
