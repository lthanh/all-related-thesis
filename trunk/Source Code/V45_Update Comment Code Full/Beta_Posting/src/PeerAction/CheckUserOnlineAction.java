...
/**
 * CheckUserOnlineAction use to check friends are online or offline
 * 
...
public class CheckUserOnlineAction {
    ...
    // use to edit status of friends in the list of friends
    ...
    // use to check the Pong message are content of friends in the list
