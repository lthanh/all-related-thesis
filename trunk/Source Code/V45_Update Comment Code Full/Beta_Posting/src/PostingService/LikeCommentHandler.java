...
/**
 * LikeCommentHandler use to handle Like and Comment messages 
 *
    ...
    public void run() {
        if (likeMessage != null) {
            if (!likeTabble.containsKey(likeMessage.getMessageID())) {
                ...
                // if super peer receive the message, it will check to store and forward to other one.
                if (isServer) {
                ...
                // check whether the message related to user logging in and update notifications
