...
/**
 * AppGUI is Home page of posting service
 * 
...
public class AppGUI extends javax.swing.JFrame {
    ...
    // show statuses in the list for Friends' status field
    public static void inform(Vector<String> listPostMessage) {
        listStatus.setListData(listPostMessage);
    }

    // use to load next statuses when user sroll down the list of statuses in the Friends' status field
    ...
    // use to form a posting message and forward to other super peers
    ...
    // send public status to super peer via Network and save into database
    ...
    // use to save private statuses into user's device only
    ...
    // show diaglog information about notification
