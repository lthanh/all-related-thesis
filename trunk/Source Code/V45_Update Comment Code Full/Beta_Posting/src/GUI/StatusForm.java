...
/**
 * StatusForm uses to show more detail of a status
 * 
...
public class StatusForm extends javax.swing.JFrame {
    ...
    // use to update status from super peers including number of like, comments, content of comments
    ...
    // use to check whether user who is logging in in the service that liked on the status
