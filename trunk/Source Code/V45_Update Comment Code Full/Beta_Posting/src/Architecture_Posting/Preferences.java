...
public class Preferences {
    ...
    public static String FILE_NAME = Login.SHAREPATH + "preferences.txt";
    ...
    /*
     * readFromFile use to get Host and other essential information to join the network 
     */
    ...
    /*
     * writeToFriendsPeer use to set list of friends group
     */
    ...
    /*
     * statusWriteToFilePeer use to save user's status at user's device
     */
    ...
    /*
     * statusWriteToFileSuperPeer use to save peer's status at Super peer
     */
    ...
    /*
     * likeWriteToFileSuperPeer use to save like message at Super peer
     */
    ...
    /*
     * commentWriteToFileSuperPeer use to save comment message at Super peer
     */
    ...
    /*
     * readFriendFile use to get list of Friend in the listFriendPeer file
     */
    ...
    /*
     * readListPeerManage use to get list of peers, which Super peer is managing
     */
    ...
    /*
     * readPrivatePOST use to get list of private status at user's device only
     */
    ...
    /*
     * readUserPOSTorNEWSFEED use to get list of public status of a user in their newsfeed and profile file
     */
    ...
    /*
     * readUserFile use to get list of like or comment on a status
     */
    ...
    /*
     * writeNewsFeed use to save friends' statuses for a user
     */
